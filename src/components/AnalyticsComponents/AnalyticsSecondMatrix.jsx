...
const AnalyticsSecondMatrix = ({
    ...
    const handleCheck = (item) => {
        ...
        const updatedMatrix = allAnalyticsMatrixData?.map((matrix) => {
            if (
                matrix.matrix_auto_id === item.matrix_auto_id &&
                                    ...
                                    >
                                        {(provided) => (
                                            <div
                                                ...
                                                className={`${matrix?.matrix_checked
...
export default AnalyticsSecondMatrix;

	...
	return (
			...
			<div className='card-content pdglr16 is_analytics_app'>
				{renderCard(
					...
					<>
						...
						<p>
							Your earnings accrued so far. This amount is an estimate that is subject to change when your
							earnings are verified for accuracy at the end of every month.
						</p>
					</>,
					'estimateEarnings',
				...
				{renderCard(
					...
					<>
						<h4>Impressions</h4>
						<p>
							The total number of ads shown to users across all of your ad units and apps through waterfall
							and bidding mediation. Includes a period-over-period comparison.
						</p>
					</>,
					'Impression',
					activityPerformanceData?.activity_performance?.impr?.dashboard_performance_impr,
					{
						...
						previous:
							activityPerformanceData?.activity_performance?.impr?.total_estimated_impr_tooltip_previous,
					}
				)}
				...
				{renderCard(
					...
					'matchRate',
					activityPerformanceData?.activity_performance?.match_rate?.dashboard_performance_match_rate,
					{
						current:
        ...
        {renderCard(
            ...
            <>
              ...
              <p>
                An estimate of the revenue you receive for every thousand
                ad impressions. eCPM is calculated as {"("} Total Earnings
                / Impressions {")"} x 1000.
              </p>
              <p>
            ...
            {
              current: activityPerformanceData?.activity_performance?.ecpm?.total_estimated_ecpm_tooltip_current,
              previous: activityPerformanceData?.activity_performance?.ecpm?.total_estimated_ecpm_tooltip_previous,
            }
          )}
          ...
          {renderCard(
            ...
            {
              current: activityPerformanceData?.activity_performance?.cost?.total_estimated_cost_tooltip_current,
              previous: activityPerformanceData?.activity_performance?.cost?.total_estimated_cost_tooltip_previous,
            }
          )}
            ...
            "active_users",
            activityPerformanceData?.activity_performance?.active_users?.dashboard_performance_active_users,
            {
              current: activityPerformanceData?.activity_performance?.active_users?.total_active_users_tooltip_current,
              previous: activityPerformanceData?.activity_performance?.active_users?.total_active_users_tooltip_previous,
            }
          )}
         ...
         {renderCard(
            ...
            "impr_per_user",
            activityPerformanceData?.activity_performance?.impr_per_user?.dashboard_performance_impr_per_user,
            {
              current: activityPerformanceData?.activity_performance?.impr_per_user?.total_impr_per_user_tooltip_current,
              previous: activityPerformanceData?.activity_performance?.impr_per_user?.total_impr_per_user_tooltip_previous,
            }
          )}
            ...
            <>
              <h4>C.ROAS</h4>
              <>
                C.ROAS is a marketing metric that measures the revenue earned for every dollar spent on advertising.
                <br />
                <br />
                C.ROAS is simple to calculate by dividing revenue by ad spend.
                <br />
                <br />
                (Revenue/Cost)
              </>
            ...
            {
              current: activityPerformanceData?.activity_performance?.roas?.total_roas_tooltip_current,
              previous: activityPerformanceData?.activity_performance?.roas?.total_roas_tooltip_previous,
            }
          )}
			</div>
		</div>

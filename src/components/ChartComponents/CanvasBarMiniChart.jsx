        ...
        return `<div class='tooltip-inner'>
          <div class='tooltip-value'>
            <div>
              ...
              <span>${
                (compare?.dataPoint?.value === 'estimate' ||
                  compare?.dataPoint?.value === 'ecpm') &&
                compare?.dataPoint?.y
                  ? '$'
                  : ''
              }${
                compare?.dataPoint?.y
                  ? formatValueGraph(compare.dataPoint.y, compare?.dataPoint?.value)
                  : '-'
            ...
            <div>
              ...
              <span>${
                (current?.dataPoint?.value === 'estimate' ||
                  current?.dataPoint?.value === 'ecpm') &&
                current?.dataPoint?.y
                  ? '$'
                  : ''
              }${
                current?.dataPoint?.y
                  ? formatValueGraph(current.dataPoint.y, current?.dataPoint?.value)
                  : '-'
